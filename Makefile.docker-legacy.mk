ifndef __MAKEFILE_DOCKER_LEGACY_MK__
__MAKEFILE_DOCKER_LEGACY_MK__ := 1
...
docker-publish: docker-gen-info docker-install ## Build and publish to registry
	@echo "🔄 Using builder: $(DOCKER_BUILDER_NAME)"
...
.PHONY: docker-build docker-load docker-publish docker-targets

endif # __MAKEFILE_DOCKER_LEGACY_MK__