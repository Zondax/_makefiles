ifndef __MAKEFILE_INFRA_MK__
__MAKEFILE_INFRA_MK__ := 1
...
.PHONY: infra-checks infra-lint infra-kubeconform infra-kubeconform-install

endif # __MAKEFILE_INFRA_MK__
